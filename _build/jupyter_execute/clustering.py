...
kmeans_margin_average = KMeans(n_clusters=3).fit(joined[["Margin", "Average Choice"]])
centroids_betas_average = kmeans_margin_average.cluster_centers_
...
plt.figure(figsize=(16,8))
plt.scatter(joined['Margin'], joined['Average Choice'], c= kmeans_margin_average.labels_, cmap = "Set1", alpha=0.5)
plt.scatter(centroids_betas_average[:, 0], centroids_betas_average[:, 1], c='blue', marker='x')
